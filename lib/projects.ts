export const projects = [
    {
        ...
        slug: 'minkey-app',
        techno: ['Flutterflow', 'Firebase', 'Make'],
        company: 'Minkey',
        date: '04/2025',
        cover: '/projects/app-mobile/home_page.png',
        link: 'https://minkey-app.flutterflow.app/',
        illustration: ['/projects/app-mobile/create_account.png', '/projects/app-mobile/welcome.png'],
    ...
    },
    {
        ...
        title: 'Minkey',
        slug: 'minkey-site',
        techno: ['PHP', 'Wordpress', 'CSS'],
        company: 'Minkey',
        date: '01/2025',
        cover: '/projects/minkey/1.png',
        link: 'https://minkey.fr',
