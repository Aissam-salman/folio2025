        ...
        <div className="min-h-screen w-full py-6 px-4 sm:px-10 relative">
          ...
          <main className="relative z-20">
            <header className="py-6 px-4 flex gap-2 flex-col">
              ...
              <h2 className="mt-4 sm:text-5xl text-3xl lg:text-7xl font-extrabold text-red-500 gradient-text ">
                Developpeur Full Stack,
              </h2>
              <div className="font-kaori text-2xl text-stone-200">
                Spécialisé PHP & React
              </div>
              <div className={"text-[#00A8E8]/80 mb-12 lg:w-1/3 lg:text-xl"}>
                J&#39;aide les entrepreneurs à transformer leurs idées en
                applications web sur mesure, en combinant un back-end robuste et
                un front-end fluide, avec une vraie attention à l&#39;UX et aux
                besoins du terrain.
              </div>
            </header>
            <main className="flex flex-col gap-16 py-16 px-4">
              <div className="flex flex-col items-end gap-8">
                <h3 className="font-bold text-3xl text-[#00A8E8]/80">
                  Mes projets recents
                </h3>
                <div className="flex flex-col items-end sm:flex-row gap-8">
                  <HoverImageEffect
                    link="/projects/minkey-app"
                    className="lg:text-3xl text-right font-kaori text-stone-200"
                    text="Application&nbsp;mobile&nbsp;Saas"
            ...
            <footer className="fixed bottom-0 left-0 right-0 px-12 py-8 bg-linear-to-t from-black/10 to-transparent backdrop-blur-xs">
              <div className="flex flex-row items-center justify-center gap-8 relative">
                <div className="flex gap-4">
                  ...
                  >
                    <button className="ghost-button-variant">
                      Prendre RDV
                    </button>
                  </a>
                </div>
                <div className="lg:absolute hidden right-0 sm:flex gap-4 ">
                  <a
